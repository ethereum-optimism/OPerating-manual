...
Version validation is a strict, critical requirement. To securely hand over upgradability to the Collective, a chain’s L1 smart contracts must be deployed by the canonical OP Contracts Manager ("OPCM") address on Ethereum, [`0x56ebc5c4870f5367b836081610592241ad3e0734`](https://etherscan.io/address/0x56ebc5c4870f5367b836081610592241ad3e0734). This is an automated L1 deployment contract which deploys chains based on `op-contracts@v4.0.0`.
