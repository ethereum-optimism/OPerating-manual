...
Version validation is a strict, critical requirement. To securely hand over upgradability to the Collective, a chain’s L1 smart contracts must be deployed by the canonical OP Contracts Manager ("OPCM") address on Ethereum, [`0x8123739c1368c2dedc8c564255bc417feeebff9d`](https://etherscan.io/address/0x8123739c1368c2dedc8c564255bc417feeebff9d). This is an automated L1 deployment contract which deploys chains based on `op-contracts@v4.1.0`.
