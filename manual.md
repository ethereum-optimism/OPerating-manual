...
- **Approved by at least one delegate.** Over the course of discussion and feedback, at least one Delegate with more than 0.5% of voting power must signal that they believe the proposal is ready for vote. In the spirit of governance minimization, this document will not codify an explicit approval mechanism but will expect community members to interpret this appropriately.
