...
- **Approval threshold:**  The minimum number of OP votes required to be cast in favor of approving a proposal. The approval threshold for each proposal is measured as *a % of votes cast to approve (relative to the total number of votes cast in connection with) a proposal*.
...
|Governance Fund  (Phase 1)      |OP distributions to proactively incentivize future growth of projects and communities in the Optimism ecosystem. [Phase 1](https://community.optimism.io/docs/governance/gov-fund/#:~:text=%23-,Phase%201,-Phase%201%20) begins after Airdrop #1                                                              |Forum + Snapshot                                                                                                                                                                                                                                                                          |1 (~2 weeks)                       |0.1                                                   |0.51                                                                               |
